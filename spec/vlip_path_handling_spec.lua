...
describe("VLIP path handling", function()
  ...
  describe("paths with special characters", function()
    ...
    it("should handle paths with quotes and backslashes", function()
      ...
      -- Verify the symlinks exist and point to the correct targets
      assert.equals(cfg.available_dir .. [[/plugin\'with\'quotes.lua]],
                   utils.fs_mock.get_symlink(cfg.plugins_dir .. [[/plugin\'with\'quotes.lua]]))
      assert.equals(cfg.available_dir .. [[/plugin\\with\\backslashes.lua]],
                   utils.fs_mock.get_symlink(cfg.plugins_dir .. [[/plugin\\with\\backslashes.lua]]))
    end)
  end)
